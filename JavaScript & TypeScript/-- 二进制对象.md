...
> Recently revised in 08 Jan 2023
...
**ArrayBuffer** 对象用于表示通用的，固定长度的原始二进制数据缓冲区，存在内存中的，可以直接操作。你不能直接操纵 ArrayBuffer 的内容，而是需要创建一个类型化数组对象或 DataView 对象，该对象以特定格式表示缓冲区，并使用该对象读取和写入缓冲区的内容。
...
- ArrayBuffer 纯.01 构成的串，不知道第一个元素和第二个元素需要如何分割
- TypedArray 九中类型的构造函数，根据九种类型，去分割
...
<img src="C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20230102200409713.png" alt="image-20230102200409713" style="zoom: 80%;" />
...
|                  | https://mp.weixin.qq.com/s?__biz=MzI2MjcxNTQ0Nw==&mid=2247484317&idx=1&sn=c0b397b6bd5fdfced0c1bebc187a7c0d&scene=21 |
