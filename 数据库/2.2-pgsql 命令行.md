...
如果你想要线上编辑和执行 sql，你可以使用：[https://sqlfiddle.com/](https://sqlfiddle.com/)
...
从多行中计算出一个结果，比如`count`（计数）、`sum`（和）、`avg`（均值）、`max`（最大值）和`min`（最小值）的函数
...
| 文章名称               | 链接                                                                                                         |
| ------------------ | ---------------------------------------------------------------------------------------------------------- |
| PostgreSQL 17.5 手册 | [http://www.postgres.cn/docs/17/tutorial-select.html](http://www.postgres.cn/docs/17/tutorial-select.html) |
|                    |                                                                                                            |
|                    |                                                                                                            |
|                    |                                                                                                            |
