...
- 安装 npm 组件：[https://www.npmjs.com](https://www.npmjs.com)
...
| 命令（常用命令）               | 功能                                |
| ---------------------- | --------------------------------- |
| `npm root -g`          | 查看全局模块的安装路径 如果使用 nvm 管理工具，位置可能会不同 |
...
nvm（Linux、Unix、OS X）的安装：[https://github.com/creationix/nvm](https://github.com/creationix/nvm)

nvm（Windows）安装：[https://github.com/coreybutler/nvm-windows](https://github.com/coreybutler/nvm-windows)
