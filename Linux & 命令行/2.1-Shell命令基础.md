...
- lsof（list open files）：列出当前系统打开文件，也可以用来查看端口的使用情况
...
# 查看所有打开的端口
lsof -i
# 查看特定端口的使用情况，例如 8080 端口
lsof -i:8080
# 配合 kill <pid> 命令可以终止对应的进程
kill -9 <pid>
```
...
| 作者      | 链接                                                                                       |
| ------- | ---------------------------------------------------------------------------------------- |
| ICer消食片 | [https://zhuanlan.zhihu.com/p/455678992](https://zhuanlan.zhihu.com/p/455678992)         |
| czpcalm | [https://juejin.cn/post/7130982053528469511](https://juejin.cn/post/7130982053528469511) |
